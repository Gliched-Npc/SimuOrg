...
def full_calibration_patch(tmp_path):
    ...
    patches = {
        ...
        "eng_features":  patch("backend.core.ml.calibration.engineer_features",
    ...
    started["session"].return_value.__enter__.return_value.exec.return_value.all.return_value = employees
...
class TestCalibrationOutputSchema:
    ...
    REQUIRED_KEYS = [
        "quit_threshold", "stress_threshold", "motivation_threshold",
        "avg_quit_prob", "avg_burnout_limit", "annual_attrition_rate",
        "monthly_natural_rate", "stress_gain_rate", "behavior_stress_gain_rate",
        "recovery_rate", "prob_scale", "stress_amplification",
        "new_hire_monthly_prob", "calib_quality", "calib_attrition_std",
    ]
