        ...
        <React.Fragment key={i}>
          <div style={{
            ...
            <div style={{
              ...
              background: step.done ? 'rgba(74,222,128,0.12)'
                        : step.active ? 'rgba(137,44,220,0.18)'
                        : 'rgba(188,111,241,0.06)',
              border: `2px solid ${step.done ? '#4ade80' : step.active ? '#892CDC' : 'rgba(188,111,241,0.2)'}`,
              transition: 'all 0.4s ease',
              boxShadow: step.active ? '0 0 15px rgba(137,44,220,0.3)' : 'none',
            }}>
              {step.done ? (
                <Check size={18} color="#4ade80" />
              ) : step.active ? (
                <Loader size={18} color="#BC6FF1" style={{ animation: 'spin 1.5s linear infinite' }} />
              ) : (
                <Clock size={18} color="rgba(188,111,241,0.4)" />
              )}
            </div>
            ...
            <span style={{
              fontSize: '0.75rem',
              fontWeight: 600,
              color: step.done ? '#4ade80' : step.active ? '#BC6FF1' : 'rgba(188,111,241,0.4)',
              whiteSpace: 'nowrap',
          ...
          {i < steps.length - 1 && (
            <div style={{
              ...
              margin: '0 10px',
              marginBottom: 26,
              background: steps[i+1].done || step.done
