const COLORS = {
  purple:  { grad: '#892CDC', bg: 'rgba(137,44,220,0.15)' },
  lavender:{ grad: '#BC6FF1', bg: 'rgba(188,111,241,0.12)' },
    ...
    >
      ...
      {delta && (
        <div style={{
          ...
          color: deltaDir === 'up'   ? '#4ade80'
               : deltaDir === 'down' ? '#f87171'
               : 'rgba(188,111,241,0.55)',
        }}>
