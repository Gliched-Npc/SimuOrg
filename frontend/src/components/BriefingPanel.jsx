...
export default function BriefingPanel({ result }) {
  ...
  const attrition_verdict =
    briefing.performance?.attrition_verdict?.toUpperCase() || "STABLE";
  const verdictColor = VERDICT_COLOR[attrition_verdict] || "#33c9cf";
    ...
    >
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "0.8rem", color: "rgba(51,201,207,0.6)" }}>
      ...
      >
        {[
          ...
          },
          {
            ...
            value:
              analytics.headcount?.pct_change != null
                ? `${analytics.headcount.pct_change > 0 ? "+" : ""}${
                    analytics.headcount.pct_change
                  }%`
                : "—",
            color:
              analytics.headcount?.pct_change >= -5 ? "#4ade80" : "#f87171",
            icon:
              analytics.headcount?.pct_change >= 0 ? TrendingUp : TrendingDown,
          },
          {
            label: "Voluntary Quits Δ",
            value:
              analytics.attrition?.vs_baseline_pts != null
                ? `${analytics.attrition.vs_baseline_pts > 0 ? "+" : ""}${
                    analytics.attrition.vs_baseline_pts
                  } pts`
                : "—",
            color:
              analytics.attrition?.vs_baseline_pts <= 0 ? "#4ade80" : "#f87171",
            icon:
              analytics.attrition?.vs_baseline_pts <= 0
                ? TrendingDown
                : TrendingUp,
          },
          {
            ...
            value:
              analytics.metrics?.productivity?.pct_change != null
                ? `${analytics.metrics.productivity.pct_change > 0 ? "+" : ""}${
                    analytics.metrics.productivity.pct_change
                  }%`
                : "—",
            color:
              analytics.metrics?.productivity?.pct_change >= 0
          ...
          },
          {
            label: "Risk Level",
            value: risk_level,
            color: SEVERITY_COLOR[risk_level] || "#33c9cf",
            icon: AlertTriangle,
          },
        ].map((m, i) => (
          <div
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        borderRadius: 6,
                        background: `${
                          SEVERITY_COLOR[sev] || SEVERITY_COLOR["LOW"]
                        }15`,
          ...
          <div className="glass-card" style={{ padding: "1.25rem", flex: 1 }}>
            ...
            >
              ...
              >
                <span
                  style={{ color: "#33c9cf", fontWeight: 900, marginTop: 2 }}
                >
                  ⚡
                </span>
