...
export default function Simulate() {
  ...
  useEffect(() => {
    ...
    if (location.state?.jobId) {
      ...
      if (targetPrompt)
        localStorage.setItem("simuorg_last_prompt", targetPrompt);
    }
  ...
  const handleRun = async () => {
    ...
    try {
      const { result: res, job_id } = await orchestrateAndPoll(
        prompt,
        setStatus,
      );
      setResult(res);
  ...
  return (
    <div
      style={{ animation: "fadeIn 0.4s ease", maxWidth: 900, margin: "0 auto" }}
    >
      {/* ── Page Header ────────────────────────────────────── */}
      <div style={{ marginBottom: "2.5rem" }}>
        <h1 className="page-title">Policy Simulation</h1>
        <p className="page-sub">
          Describe an HR policy in plain English — the AI pipeline handles the
          rest.
        </p>
      </div>
      ...
      >
        ...
        <textarea
          ...
          onFocus={(e) => {
            ...
            e.target.style.boxShadow = "0 0 0 3px rgba(0,173,181,0.18)";
          }}
          onBlur={(e) => {
            e.target.style.borderColor = "rgba(51,201,207,0.25)";
            ...
            {EXAMPLE_PROMPTS.map((p, i) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid rgba(51,201,207,0.18)",
                ...
                onMouseOver={(e) => {
                  ...
                  e.currentTarget.style.color = "#33c9cf";
                }}
                onMouseOut={(e) => {
                  e.currentTarget.style.background = "rgba(0,173,181,0.1)";
                  e.currentTarget.style.color = "rgba(51,201,207,0.8)";
                }}
              >
                {p.slice(0, 40)}…
              </button>
        ...
        >
          <span style={{ fontSize: "0.75rem", color: "rgba(51,201,207,0.35)" }}>
            ⌘ + Enter to run
          </span>
          <div style={{ display: "flex", gap: "0.75rem" }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow:
                  !loading && prompt.trim()
                    ? "0 4px 24px rgba(0,173,181,0.45)"
                    : "none",
              }}
              onMouseOver={(e) => {
      ...
      {error && (
        ...
        >
          ...
          <div>
            ...
            <div
              style={{ color: "rgba(248,113,113,0.8)", fontSize: "0.85rem" }}
            >
              {error}
            </div>
          </div>
